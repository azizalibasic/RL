...
if __name__ == "__main__":
    ...
    ALPHA = 0.01
    w0 = run_v1(a=0.01, l=0.0, debug=True)
    w1 = run_v1(a=0.01, l=0.1, debug=True)
    w3 = run_v1(a=0.01, l=0.3, debug=True)
    w5 = run_v1(a=0.01, l=0.5, debug=True)
    w7 = run_v1(a=0.01, l=0.7, debug=True)
    w10 = run_v1(a=0.01, l=1.0, debug=True)
